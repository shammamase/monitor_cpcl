...
$pageTitle = 'Tambah Komoditas - UPBS';
$activeMenu = 'master';
...
<div class="card page-card">
    <div class="card-body">
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 gap-2">
            <div>
                <h4 class="mb-1">Tambah Komoditas</h4>
                <div class="text-muted">Tambahkan data komoditas baru untuk modul UPBS.</div>
            </div>
            <a href="<?= base_url('page_upbs/komoditas/index.php') ?>" class="btn btn-outline-secondary">Kembali</a>
        </div>

        <form action="<?= base_url('page_upbs/komoditas/store.php') ?>" method="POST">
            <div class="mb-3">
