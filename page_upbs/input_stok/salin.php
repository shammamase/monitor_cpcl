...
/*
|--------------------------------------------------------------------------
| Ambil header sumber, pastikan milik satker user
|--------------------------------------------------------------------------
*/
...
$oldInput = $_SESSION['old_input_salin_stok'] ?? [];
$error = $_SESSION['error_message_upbs'] ?? '';
unset($_SESSION['old_input_salin_stok'], $_SESSION['error_message_upbs']);

if (!empty($oldInput)) {
    $formHeader = [
        'source_id'          => $id_laporan_stok,
    ...
    $formHeader = [
        ...
        'nama_petugas_input' => $userUpbs['nama_lengkap'] ?? $header['nama_petugas_input'],
...
$pageTitle = 'Update Input Stok - UPBS';
...
<form action="<?= base_url('page_upbs/input_stok/store_salin.php') ?>" method="POST" id="formInputStokSalin">
    <input type="hidden" name="source_id" value="<?= (int)$formHeader['source_id'] ?>">

    <div class="card section-card mb-4">
        <div class="card-body">
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-2 mb-4">
                <div>
                    <h4 class="section-title">Update Input Stok</h4>
                    <p class="section-subtitle">Form ini mengambil data laporan sebelumnya sebagai template, lalu akan disimpan sebagai laporan baru.</p>
                </div>
        ...
        <div class="card-body">
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-2 mb-3">
                <div>
                    ...
                    <p class="section-subtitle">Ubah angka, tambah item baru, atau hapus item yang tidak diperlukan sebelum disimpan sebagai laporan baru.</p>
                </div>
            ...
            <div class="mini-note mb-3">
                Catatan: tombol Update ini akan membuat laporan baru, bukan menimpa laporan lama.
            </div>

            <div class="d-flex flex-wrap gap-2">
                <button type="button" class="btn btn-success" id="btnSimpanUpdateBaru">Simpan Sebagai Laporan Baru</button>
...
document.getElementById('btnSimpanUpdateBaru').addEventListener('click', function() {
    document.getElementById('formInputStokSalin').submit();
});
